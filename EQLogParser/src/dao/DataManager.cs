...
namespace EQLogParser
{
    ...
    class DataManager
    {
        ...
        private readonly List<ActionBlock> AllZoneBlocks =
            new List<ActionBlock>();
        ...
        internal void AddZoneRecord(ZoneRecord record, double beginTime)
        {
            Helpers.AddAction(AllZoneBlocks, record, beginTime);
        }

        internal void AddLevelRecord(LevelRecord record, double beginTime)
        {
